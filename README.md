...
- The idle-disconnect watcher is configurable through `idleDisconnectWatch` and only detects/logs the prompt by default; it does not click the prompt automatically.
